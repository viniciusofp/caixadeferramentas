...
<div class="caixa-wrapper" ng-app="caixaDeFerramentas" ng-controller="MainController">
			...
			<div class="col-12">
				<form class="form-inline">
				  ...
				  <div class="input-group mb-2 mr-sm-4">
					  <input type="text" class="form-control mb-2 mr-sm-2" ng-model="postFilter.textQuery">
				  </div>
				  <div class="input-group mb-2 mr-sm-3">
						<p>Categoria: </p>
					</div>
